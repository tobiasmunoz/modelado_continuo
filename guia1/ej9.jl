...
# ╔═╡ 2cae8d62-a9c6-4674-a8c5-980efb8f3902
using DifferentialEquations, Plots

# ╔═╡ 1ca75784-4738-11ee-119e-9113a0e443a5
md""" # Ejercicio 9 """

# ╔═╡ 253c0cb9-56b3-4124-9aa7-ed7bb69f1f20
md"""
S = susceptibles (u1), I = infectados (u2), R = recuperados (u3)
"""

# ╔═╡ dc5b835a-2083-4052-acd5-4e9588b99f9a
function sir(u,p,t)
	N, β, γ = p
	du = zeros(length(u))
	du[1] = -β*u[1]*u[2]/N
...
# ╔═╡ 9ea92682-b157-46d7-bad9-b2df5ba108d6
begin
	params = (10000, 0.2, 10/365)
	u₀ = [9999, 1, 0]
	ts = [0., 120.]
	sir_prob = ODEProblem(sir, u₀, ts, params)
end

# ╔═╡ a4b21ce5-f394-4d78-87e6-9d4eebb6c97e
begin
	sol_sir = solve(sir_prob)
	plot(sol_sir)
end
