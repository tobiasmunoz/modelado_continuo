...
# ╔═╡ 975092a1-23fd-4f99-8ee6-733fc3c2b4b9
using DifferentialEquations, Plots

# ╔═╡ b2ca7554-9ee5-47a8-b16b-ecec414bceb0
md""" # Ejercicio 7 """

# ╔═╡ acb62c14-c01b-412b-8b7b-3094627d4178
md""" # b), c) """

# ╔═╡ 9ec04308-472d-11ee-0cb5-a9bc087ed66c
function pred_presa(u,p,t)
	α,β,γ,δ = p
	du = zeros(length(u))
...
# ╔═╡ 86a85c1a-61f5-4788-9308-f5ba8fb69e3d
begin
	
	params_1 = [0.5, 0.5, 0.5, 0.5]
	params_2 = [0.25, 1, 0.01, 0.01]
	
	U₀ = [2, 2]
	U₁ = [1/0.01 + 10, 0.25/0.01 + 5]
	
	ts = (0.,50.)
	
	pred_presa1 = ODEProblem(pred_presa, U₀, ts, params_1)
	pred_presa2 = ODEProblem(pred_presa, U₁, ts, params_2)
	
	sol1 = solve(pred_presa1)
	sol2 = solve(pred_presa2)

		
	sistema1 = plot(sol1)
	sistema2 = plot(sol2)
	sistema_x_vs_y_1 = plot( sol1, idxs = (1,2) )
	sistema_x_vs_y_2 = plot( sol2, idxs = (1,2) )
	
	plot(sistema1, sistema_x_vs_y_1, sistema2, sistema_x_vs_y_2, layout = (2,2))
