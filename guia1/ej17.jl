...
# ╔═╡ 195f9a36-57b5-11ee-3658-a59f8db8f4b3
using Plots,DifferentialEquations

# ╔═╡ 8e710371-e562-44b8-99d1-f7ca447ec0fd
md""" # Ejercicio 17 """

# ╔═╡ ffd60c87-65ee-43a9-b773-808f35b7ffe8
md""" # a) """

# ╔═╡ ab36a9a0-c914-4f62-8056-a2295127778f
...
# ╔═╡ a5bd37c5-8e7c-429d-a738-80209e66c634
md""" # b) """

# ╔═╡ bf049971-9428-4214-b31e-e9ec586efc57
...
# ╔═╡ 6cacca30-efb8-4386-b613-21cf27c16c0d
function condicion_piso(u,t,integrator)
	u[2]
end

# ╔═╡ 8688c682-11de-472c-b42a-7c6bc48b80b0
begin
	cb_finish = ContinuousCallback(condicion_piso,terminate!)
	s₁ = resolucion_mov(1,cb_finish) # Bala de cañon
	ts = 0:0.01:4
	plot(ts,s₁(ts)[2,:], label = "y(t) bala cañon")

	s₂ = resolucion_mov(2,cb_finish) # Bala de mosquete
	plot!(ts,s₂(ts)[2,:], label = "y(t) bala mosquete")
	
end

# ╔═╡ 036420fb-856e-4f2d-8c99-43bc8316c29a
md""" # c), d) """

# ╔═╡ c16d57f0-5454-40b1-bb2c-8ff1b28929b7
md""" La bala de cañon llega al suelo a los 3.38 seg y la de mosquete a los 3.51 seg.
 Cuando la de cañon llega al suelo, la de mosquete se encuentre a a 1.6 metros aproximadamente del suelo"""

# ╔═╡ 3a6497dd-d556-419e-9870-cec9820f19ea
s₁, s₂
